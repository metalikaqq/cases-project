...
// import ukraineFlagIco from "@/assets/svg/ukraine-flag-ico.svg"; // Adjust the path as necessary
// import usaFlagIco from "@/assets/svg/english-flag-ico.svg"; // Adjust the path as necessary
// import arrowDown from "@/assets/svg/arrow-down-black.svg"; // Adjust the path as necessary
...
//       <div className={s.currency_picker}>
//         <Image
...
//       </div>
//       <select
//         className={s.currency_picker__select}
//         disabled={isPending}
